            ...
            <div className="relative">
                ...
                {showAddMenu && (
                  <div className="absolute bottom-full right-0 mb-4 bg-black/90 backdrop-blur-xl border border-white/10 rounded-2xl grid grid-cols-2 shadow-2xl overflow-hidden w-64 animate-in slide-in-from-bottom-2 fade-in">
                        ...
                        <button onClick={() => { onAddWidget('todoist'); setShowAddMenu(false); }} className="py-3 px-2 text-sm text-white hover:bg-white/10 transition border-b border-white/5">Todoist</button>
                        <button onClick={() => { onAddWidget('youtube'); setShowAddMenu(false); }} className="py-3 px-2 text-sm text-white hover:bg-white/10 transition border-r border-b border-white/5">YouTube</button>
                        <button onClick={() => { onAddWidget('tab'); setShowAddMenu(false); }} className="py-3 px-2 text-sm text-white hover:bg-white/10 transition border-r border-b border-white/5">Website</button>
